...
public class Agent extends AbstractHeuristicMultiPlayer {
     ...
     */
    private double evaluate(Individual individual, MultiStateHeuristic heuristic, StateObservationMulti state) {
