...
public class SingleTreeNode
{
    ...
    private MultiStateHeuristic heuristic;

    public SingleTreeNode(Random rnd, int[] NUM_ACTIONS, Types.ACTIONS[][] actions, int id, int oppID, int no_players, MultiStateHeuristic heuristic) {
        this(null, -1, rnd, id, oppID, no_players, NUM_ACTIONS, actions, heuristic);
    }

    public SingleTreeNode(SingleTreeNode parent, int childIdx, Random rnd, int id, int oppID, int no_players, int[] NUM_ACTIONS, Types.ACTIONS[][] actions, MultiStateHeuristic heuristic) {
    ...
    public SingleTreeNode expand(StateObservationMulti state) {
        ...
        advanceState(state, acts);

        SingleTreeNode tn = new SingleTreeNode(this,bestAction,this.m_rnd, id, oppID, no_players, NUM_ACTIONS, actions, heuristic);
    ...
    private void advanceState(StateObservationMulti state, Types.ACTIONS[] acts){
        state.advance(acts);
